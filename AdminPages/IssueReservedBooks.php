 <?php
//incase a student reserves a  book then this page is used to issue the reserved book
//start session
session_start();
...
//once the user submits the issue form details
...
if(mysqli_query($conn,$query)){
  ...
  echo "<script>alert('The Student has a Book');</script>";
...
<!-- Issue reserved books form -->
<div class="form-controls">

<form role="form" method="post" action="IssueReservedBooks.php">
